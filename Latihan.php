...
<body>
    <main class="position-absolute top-50 start-50 translate-middle">
        <div class="card">
        <h1 style="text-align: center;">What's the <span style="color: red;">s</span><span style="color: orange;">e</span><span style="color: yellow;">a</span><span style="color: green;">s</span><span style="color: blue;">o</span><span style="color: purple;">n</span></span> at that time?</h1>
            <div class="card-body">
                <h5 class="card-title">
                    <table align="center" border="1" cellspacin="10">
                        <form action="musim.php" method="post">
                            <tr>
